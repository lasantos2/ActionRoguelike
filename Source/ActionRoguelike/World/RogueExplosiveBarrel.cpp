...
float ARogueExplosiveBarrel::TakeDamage(float DamageAmount, const struct FDamageEvent& DamageEvent,
                                        class AController* EventInstigator, AActor* DamageCauser)
{
	...
	ActiveBurningEffectComp = UNiagaraFunctionLibrary::SpawnSystemAttached(
		OnFireEffect, StaticMeshComp, NAME_None, FVector::ZeroVector, FRotator::ZeroRotator,
